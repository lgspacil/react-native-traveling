...
export const addPlace = (placeName, location, image) => {
    return dispatch => {
        ...
        fetch("https://us-central1-react-native-myt-1530315514387.cloudfunctions.net/storeImage", {
            method: "POST",
            body: JSON.stringify({
                image: image.base64
            })
            ...
            .then(parsedRes => {
                ...
                return fetch("https://react-native-myt-1530315514387.firebaseio.com/places.json", {
                    method: "POST",
